...
class SPMXController extends RestController
{
    public function search($token ='',$date ='',$page ='',$pagesize ='',$type ='',$id ='')
    {
        ...
        if ($type ==''){
            ...
            $totaldepartment = M()->query($sql);
            $sql = $sql." limit $pages,$pagesize";
        }		
        $depart = M()->query($sql);
        $title = json_decode('{"page":1,"pagesize":20,"total":2,"data":[{"tr":[{"dataType":0,"value":"部门","rowspan":1,"colspan":1,"type":""},{"dataType":0,"value":"类别","rowspan":1,"colspan":1,"type":""},{"dataType":0,"value":"有效/无效","rowspan":1,"colspan":1,"type":""},{"dataType":0,"value":"对方部门","rowspan":1,"colspan":1,"type":""},{"dataType":0,"value":"防盗门","rowspan":1,"colspan":1,"type":""},{"dataType":0,"value":"数码产品","rowspan":1,"colspan":1,"type":""}]}]}','json');
        foreach ($depart as $k1 => $v1)
        {
            $title5 = json_decode('{"tr":[{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"类别"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"有效/无效"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"对方部门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"防盗门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"数码产品"}]}',true);
            $title6 = json_decode('{"tr":[{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"部门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"类别"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"有效/无效"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"对方部门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"防盗门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"数码产品"}]}',true);
            $title4 = json_decode('{"tr":[{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"有效/无效"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"对方部门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"防盗门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"数码产品"}]}',true);
            $title3 = json_decode('{"tr":[{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"对方部门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"防盗门"},{"dataType":0,"value":"","rowspan":1,"colspan":1,"type":"数码产品"}]}',true);
            ...
            if ($type =='')
            {
                ...
                $title['total'] = ceil(count($totaldepartment)/$pagesize);
    ...
    public function uploadExcel($date ='',$bumen_id ='')
    {
        ...
        foreach ($dept_id as $k1 => $v1)
        {
            ...
            if (!count($cx))
            {
                ...
                //设置excel标题
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1','部门');            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('B1','类别');            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C1','有效/无效');            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('D1','对方部门');            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('E1','防盗门');$objPHPExcel->setActiveSheetIndex(0)->setCellValue('F1','数码产品');
                $i =2;
...
//				$xls = json_decode($revurl,true);
				...
				if(!count($cxo))
				{
					...
					{
						//当前部门的文件下载地址存入数据库
						$sql = "insert into xsrb_excel(`createtime`,`dept_id`,`biao`,`date`,`url`) values(now(),".$v1['id'].",'spmx',$date,'$keys')";
						M()->execute($sql);
					}				
				}
